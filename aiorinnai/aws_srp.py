...
We do not install warrant from PyPI because it has a dependency on a library
...
class AWSSRP(object):
    ...
    def __init__(self, username, password, pool_id, client_id, pool_region=None,
        ...
        self.client = client if client else aioboto3.get_client('cognito-idp', region_name=pool_region)
